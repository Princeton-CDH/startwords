...
contributors:
  ...
  - Technical:
    ...
    - Grant Wythoff
```
- The `interlude` class can be used with the `wrap` shortcode to make a purple band that helps divide up sections of text. [See example.](https://startwords.cdh.princeton.edu/issues/2/strangers-in-the-landscape/)
