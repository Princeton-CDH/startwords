...
### Insights
{{< figure src="images/2d-stacked-bar-v2-01.svg" alt="A series of stacked bar charts comparing the number of members, numbers of borrowers, and borrowing events, and the portion of new and renewed members among each of these categories." caption="Membership activities of Shakespeare and Company lending library from 1919–1941 represented as stacked bar charts."  desc-id="stackedbar-desc" >}}
{{< wrap class="txt-only" >}}
⩩-----------------------------------------------------------------------------------⟩
