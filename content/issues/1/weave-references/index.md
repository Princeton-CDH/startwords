...
{{< figure src="images/weaving-display.jpg" alt="A scarf with alternating bands of blue fabrics resting on a table." caption="Completed weaving of the first 13 pages of Derrida’s references in chapter 1 of Of Grammatology." attr="Photo by Shelley Szwast" >}}
{{< wrap class="txt-only" >}}
⩩-----------------------------------------------------------------------------------⟩
...
Create your own data weaving of Derrida’s references in chapter 1 of _Of Grammatology_, as described in [Data Beyond Vision](https://startwords.cdh.princeton.edu/issues/1/data-beyond-vision).
...
- 9 bundles of yarn of 6 different colors: 
  - 4 light (size 3), 2 different colors for plain text, page separator, and warp. Be sure to choose a sturdy, smooth yarn for your warp. Yarn with 2 strands[^2] is recommended for warp. 
...
Note: Approximately 37 inches of warp yarn was cut and set up on the loom to weave pages 15-27, which makes up half of chapter 1 of _Of Grammatology_.
## Weaving Types
...
https://www.youtube.com/watch?v=ZypHL7S7V80

### Soumak Weave
This technique was used to represent footnotes.

{{< figure src="images/soumak-weave.jpg" alt="Composite of eight images showing various stages of weaving." caption="How to make a Soumak weave in eight steps." >}}
{{< wrap class="txt-only" >}}
⩩-----------------------------------------------------------------------------------⟩
| FIGURE. Composite of eight images showing various stages of weaving.
|
...
Continue in this pattern until you have made all the loops you want. Once done, weave a support row of Plain weave and smash that support row down into your loops. You want to really smash the loop rows down so that your weave doesn’t get super loose once you cut it off the loom.
...
Note: Before pulling ends down and tightening the top knot, make sure to match up both sides of the end pieces and then pull evenly, so that the knot ties with all ends at about the same length. Trimming is usually required for a more uniform fringe, but this helps not waste as much yarn. If starting with the rya knot (bottom up weaving), pull the end pieces below the top knot area. If you are ending with the rya knot (top down weaving) you would pull the end pieces above the top knot area.
