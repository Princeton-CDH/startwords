...
function noteCloseLinkHandler(){if(location.hash=='#'+this.parentNode.parentNode.getAttribute('id')){event.preventDefault();event.stopPropagation();pushHashAndFixTargetSelector('#');}
