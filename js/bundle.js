...
ContextualNotes.hideOnScroll=false;window.setTimeout(function(){ContextualNotes.hideOnScroll=true},seconds*1000)}},{key:"showNote",value:function showNote(){// display the current note (if one is targeted), and bind backref handler
