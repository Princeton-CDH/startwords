"use strict";function _typeof(o){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(o){return typeof o}:function(o){return o&&"function"==typeof Symbol&&o.constructor===Symbol&&o!==Symbol.prototype?"symbol":typeof o},_typeof(o)}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function")}}function _defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,_toPropertyKey(descriptor.key),descriptor)}}function _createClass(Constructor,protoProps,staticProps){if(protoProps)_defineProperties(Constructor.prototype,protoProps);if(staticProps)_defineProperties(Constructor,staticProps);Object.defineProperty(Constructor,"prototype",{writable:false});return Constructor}function _defineProperty(obj,key,value){key=_toPropertyKey(key);if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true})}else{obj[key]=value}return obj}function _toPropertyKey(arg){var key=_toPrimitive(arg,"string");return _typeof(key)==="symbol"?key:String(key)}function _toPrimitive(input,hint){if(_typeof(input)!=="object"||input===null)return input;var prim=input[Symbol.toPrimitive];if(prim!==undefined){var res=prim.call(input,hint||"default");if(_typeof(res)!=="object")return res;throw new TypeError("@@toPrimitive must return a primitive value.")}return(hint==="string"?String:Number)(input)}/* javascript for contextual notes */var ContextualNotes=/*#__PURE__*/function(){function ContextualNotes(){_classCallCheck(this,ContextualNotes);// display note if page was loaded with a footnote anchor
...
elem=elem||ContextualNotes.endnotes;elem.classList.remove("endnotes")}},{key:"endnoteIntersectionCallback",value:function endnoteIntersectionCallback(entries,observer){entries.forEach(function(entry){var elem=entry.target;if(entry.isIntersecting){ContextualNotes.showEndnotes(elem)}else{ContextualNotes.hideEndnotes(elem)}})}}]);return ContextualNotes}();// setting for hiding contextual notes on scroll; on by default
_defineProperty(ContextualNotes,"hideOnScroll",true);// setting for re-displaying endnotes when closing a contextual notes;
// off by default
_defineProperty(ContextualNotes,"showEndnotesOnClose",false);// reference to footnotes container element
_defineProperty(ContextualNotes,"endnotes",void 0);// reference to observer that toggles footnotes to endnotes
_defineProperty(ContextualNotes,"observer",void 0);document.addEventListener("DOMContentLoaded",function(){// initialize contextual notes and make available on window
